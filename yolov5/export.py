...
@torch.no_grad()
def run(
        data=ROOT / 'data/waymo.yaml',  # 'dataset.yaml path'
        weights=ROOT / '../weights/yolov5l/best.pt',  # weights path
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / '../../weights/yolov5l/best.pt', help='model.pt path(s)')
